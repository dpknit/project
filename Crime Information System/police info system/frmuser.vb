...
Public Class frmuser
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        connectiondb()
        sql = "Select * from tbllogin where serialnumber='" & DataGridView1.CurrentRow.Cells(0).Value & "'"
    ...
    Public Sub datagrid_admin()
        ...
        Do While reader.Read = True
            DataGridView1.Rows.Add(id, reader(0), reader(3), reader(4), reader(5), reader(1))
            id = id + 1
        Loop
        connection_close()
    ...
    Private Sub btnsubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsubmit.Click
        ...
        Else
            ...
            connectiondb()
            cmd = New SqlCommand("Insert Into tbllogin values('" & txtuserid.Text & "','" & txtpassword.Text & "','" & txtfirstname.Text & "','" & txtlastname.Text & "','" & txtdesignation.Text & "')", cnn)
    ...
    Private Sub btnupdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnupdate.Click
        ...
        Else
            ...
            i = cmd.ExecuteNonQuery()
            If i > 0 Then
                MessageBox.Show("user Record Updated Successfully.", "Process Completed", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Else
