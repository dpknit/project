...
Public Class rptchecking
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "police_info_system.rptchecking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptchecking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptchecking = New rptchecking
        rpt.Site = Me.Site
        Return rpt
    End Function
