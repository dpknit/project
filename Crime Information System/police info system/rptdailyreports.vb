...
Public Class rptdailyreports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "police_info_system.rptdailyreports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptdailyreports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptdailyreports = New rptdailyreports
        rpt.Site = Me.Site
        Return rpt
    End Function
