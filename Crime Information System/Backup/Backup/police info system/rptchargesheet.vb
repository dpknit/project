...
Public Class rptchargesheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "police_info_system.rptchargesheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptchargesheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptchargesheet = New rptchargesheet
        rpt.Site = Me.Site
        Return rpt
    End Function
