...
Public Class rptpermanent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "police_info_system.rptpermanent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptpermanent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptpermanent = New rptpermanent
        rpt.Site = Me.Site
        Return rpt
    End Function
