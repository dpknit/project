...
Public Class rptmostwanted
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "police_info_system.rptmostwanted.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptmostwanted
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptmostwanted = New rptmostwanted
        rpt.Site = Me.Site
        Return rpt
    End Function
