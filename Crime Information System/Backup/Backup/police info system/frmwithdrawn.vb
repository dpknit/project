...
Imports System.IO
Public Class frmwithdrawn
    Dim filepath As String
    Dim uploadfilename, randomvalue As String
    Private Sub frmwithdrawn_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        userids()
        datagrid_admin()
        uploads()
    End Sub
    Sub userids()
        connectiondb()
        sql = "Select MAX(withdrawalid) from tblwithdrawal"
        Try
            cmd = New SqlCommand(sql, cnn)
            reader = cmd.ExecuteReader()
            While reader.Read()
                txtwithdrawnid.Text = reader.Item(0) + 1
            End While
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        connectiondb()
        cmd = New SqlCommand("Insert Into tblwithdrawal values('" & txtcomplaint.Text & "','" & txtfir.Text & "','" & txtchargesheet.Text & _
                            "','" & txtcourt.Text & "','" & txtjudge.Text & _
                            "','" & txtpolice.Text & "','" & txtstation.Text & _
                            "','" & txtsuspect.Text & "','" & 1 & _
                            "','" & txtcase.Text & "','" & txtproved.Text & _
                            "','" & txtreason.Text & "','" & txtreport.Text & "')", cnn)
        i = cmd.ExecuteNonQuery()
        If i > 0 Then
            MessageBox.Show("Withdrawal Record Inserted Successfully", "Process Completed", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Else
    ...
    Sub uploads()
        ...
        connectiondb()
        cmd = New SqlCommand("Select * from tblfiles where specid ='" & txtwithdrawnid.Text & "' AND form='frmwithdrawn'", cnn)
        reader = cmd.ExecuteReader()
        While reader.Read()
    ...
    Private Sub btnupdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnupdate.Click
        ...
        connectiondb()
        cmd = New SqlCommand("Update tblwithdrawal Set Firno='" & txtfir.Text & "',Chargesheetno='" & txtchargesheet.Text & _
                             ...
                             "',Provedtillnow='" & txtproved.Text & _
                             "' Where withdrawalid=" & txtwithdrawnid.Text, cnn)
        i = cmd.ExecuteNonQuery()
        If i > 0 Then
    ...
    Private Sub DataGridView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView1.DoubleClick
        ...
        connectiondb()
        cmd = New SqlCommand("Select * from tblwithdrawal where withdrawalid ='" & DataGridView1.CurrentRow.Cells(0).Value & "'", cnn)
        reader = cmd.ExecuteReader()
        While reader.Read()
            txtwithdrawnid.Text = reader(0) '       [withdrawalid]()
            txtcomplaint.Text = reader(1)  ',[Complaintno]
            txtfir.Text = reader(2) ',[Firno]
            txtchargesheet.Text = reader(3) ',[Chargesheetno]
            txtcourt.Text = reader(4) ',[Court]
            txtjudge.Text = reader(5) ',[Judge]
            txtpolice.Text = reader(6) ',[Policeincharge]
            txtstation.Text = reader(7) ',[Stationjuridiction]
            txtsuspect.Text = reader(8) ',[Suspectname]
            txtaddress.Text = reader(9) ',[Address]
            txtcase.Text = reader(10) ',[Caserecorded]
            txtproved.Text = reader(11) ',[Provedtillnow]
            txtreason.Text = reader(12) ',[Reasonforwithdrawal]
    ...
    Private Sub btndelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btndelete.Click
        ...
        If msgbutton = Windows.Forms.DialogResult.Yes Then
            connectiondb()
            cmd = New SqlCommand("delete from tblwithdrawal where withdrawalid='" & txtwithdrawnid.Text & "'", cnn)
            i = cmd.ExecuteNonQuery()
            If i > 0 Then
            ...
            connectiondb()
            cmd = New SqlCommand("delete from tblfiles where specid='" & txtwithdrawnid.Text & "' AND form='frmstatus'", cnn)
            i = cmd.ExecuteNonQuery()
            connection_close()
        End If
        updatedelete()
    ...
    Public Sub datagrid_admin()
        ...
        connectiondb()
        cmd = New SqlCommand("Select * From tblwithdrawal", cnn)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        complaintview = "frmwithdrawn"
        frmcomplaintselect.Show()
    End Sub

    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        firview = "frmwithdrawn"
        frmfirselect.Show()
    End Sub

    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        chargesheetview = "frmwithdrawn"
