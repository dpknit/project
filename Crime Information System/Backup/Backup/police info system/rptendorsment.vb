...
Public Class rptendorsment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "police_info_system.rptendorsment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptendorsment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptendorsment = New rptendorsment
        rpt.Site = Me.Site
        Return rpt
    End Function
