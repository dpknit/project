...
Public Class rptjudgement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "police_info_system.rptjudgement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptjudgement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptjudgement = New rptjudgement
        rpt.Site = Me.Site
        Return rpt
    End Function
