...
Public Class rptsecurity
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "police_info_system.rptsecurity.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptsecurity
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptsecurity = New rptsecurity
        rpt.Site = Me.Site
        Return rpt
    End Function
