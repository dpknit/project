...
Public Class rptcriminal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "police_info_system.rptcriminal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptcriminal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptcriminal = New rptcriminal
        rpt.Site = Me.Site
        Return rpt
    End Function
