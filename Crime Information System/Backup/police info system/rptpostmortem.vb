...
Public Class rptpostmortem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "police_info_system.rptpostmortem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptpostmortem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptpostmortem = New rptpostmortem
        rpt.Site = Me.Site
        Return rpt
    End Function
